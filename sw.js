...
self.addEventListener("fetch", function (e) {
  ...
  // ni funciona offline. Rutas: /m/<código> (carpeta), /r, /r.html, /r/<código>
  // y /yt/... (la redirección del servidor hacia YouTube: debe llegar intacta al
  // navegador para que el sistema pueda abrir la app de YouTube).
  if (/(^|\/)(r(\.html)?|m|yt)(\/|$)/.test(url.pathname)) return;
